...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $dados = [
        'id_autor' => BibliotecaFuncoes::gerarNovoId('autor'),
    ...
    if (empty($dados['nome'])) {
        BibliotecaFuncoes::redirecionarCom('inserir.php', 'error', 'Nome é obrigatório');
    }
    
    if ($autorDAO->inserir($dados)) {
        BibliotecaFuncoes::redirecionarCom('listar.php', 'success', 'Autor cadastrado com sucesso');
    } else {
        BibliotecaFuncoes::redirecionarCom('inserir.php', 'error', 'Erro ao cadastrar autor');
    }
}

$novoId = BibliotecaFuncoes::gerarNovoId('autor');
?>
...
<head>
    ...
    <title>Cadastrar Autor - Biblioteca</title>
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">
                            <i class="fas fa-user-plus"></i> Cadastrar Novo Autor
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" class="needs-validation" novalidate>
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="id_autor" 
                                       value="<?= $novoId ?>" readonly>
                                <div class="form-text">ID gerado automaticamente</div>
                            </div>
